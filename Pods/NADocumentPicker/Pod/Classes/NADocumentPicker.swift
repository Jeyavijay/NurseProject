...
open class NADocumentPicker : NSObject {
     ...
     */
    open class func show(from view: UIView, parentViewController: UIViewController, documentTypes: [String] = [(kUTTypeData as? String)!,(kUTTypeBMP as? String)!,(kUTTypeXML as? String)!,(kUTTypeItem as? String)!,(kUTTypeRTF as? String)!,(kUTTypeText as? String)!,(kUTTypeRTFD as? String)!,(kUTTypeInkText as? String)!,(kUTTypeContent as? String)!,(kUTTypeDelimitedText as? String)!,(kUTTypePlainText as? String)!, (kUTTypePresentation as? String)!,(kUTTypeFolder as? String)!,(kUTTypePDF as? String)!]) -> Future<URL, AnyError> {
...
//[(kUTTypeData as? String),(kUTTypeBMP as? String),(kUTTypeXML as? String),(kUTTypeItem as? String),(kUTTypeRTF as? String),(kUTTypeText as? String),(kUTTypeRTFD as? String),(kUTTypeInkText as? String),(kUTTypeContent as? String),(kUTTypeDelimitedText as? String),(kUTTypePlainText as? String), (kUTTypePresentation as? String),(kUTTypeFolder as? String),(kUTTypePDF as? String)]
